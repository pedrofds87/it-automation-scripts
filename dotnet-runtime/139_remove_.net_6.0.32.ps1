# Script: remove .net 6.0.32
# Platform: Windows
# Description: #pstanczyk 2024-12-03
# NinjaOne Script ID: 139

# Define the path of the runtime to be uninstalled
$RuntimePath = "C:\Program Files\dotnet\shared\Microsoft.NetCore.App\6.0.32"
...
Function Force-UninstallRuntime {
    ...
    icacls "C:\Program Files\dotnet\shared\Microsoft.NetCore.App\6.0.32" /grant "Administrators:F" /t
...
Write-Output "Starting process to remove .NET Core Runtime 6.0.32..."
